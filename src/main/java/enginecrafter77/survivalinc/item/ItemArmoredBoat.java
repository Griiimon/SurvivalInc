...
import enginecrafter77.survivalinc.strugglecraft.EntityArmoredBoat;
...
public class ItemArmoredBoat extends Item
{
    private final EntityBoat.Type type;

    public ItemArmoredBoat()
    {
        this.type = EntityBoat.Type.BIRCH;
        this.maxStackSize = 1;
        this.setCreativeTab(SurvivalInc.mainTab);
		this.setRegistryName(new ResourceLocation(SurvivalInc.MOD_ID, "armored_boat"));
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                EntityArmoredBoat entityboat = new EntityArmoredBoat(worldIn, raytraceresult.hitVec.x, flag1 ? raytraceresult.hitVec.y - 0.12D : raytraceresult.hitVec.y, raytraceresult.hitVec.z);
