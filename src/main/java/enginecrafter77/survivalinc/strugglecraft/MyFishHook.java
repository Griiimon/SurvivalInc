...
public class MyFishHook extends EntityFishHook{

	public MyFishHook(World p_i1766_1_, EntityPlayer p_i1766_2_) {
		super(p_i1766_1_, p_i1766_2_);
		// TODO Auto-generated constructor stub
	}
	
	public MyFishHook(World worldIn, EntityPlayer p_i47290_2_, double x, double y, double z)
    {
        super(worldIn, p_i47290_2_);
...
//    @SideOnly(Side.CLIENT)
    ...
    public MyFishHook(World worldIn, EntityPlayer fishingPlayer)
    {
    ...
    private void checkCollision()
    {
        ...
        // we can't hook entity or it will crash 
        this.inGround = true;
    }
...
// FISH ON HOOK
                ...
                this.motionY = (double)(-2F * MathHelper.nextFloat(this.rand, 0.6F, 1.0F));
