...
public class StatFillBarHacked<RECORD extends StatRecord> implements OverlayElement<StatTracker>{
	...
	public StatFillBarHacked(Direction2D direction, TexturedElement base)
	{
